...
class CodableFeedStoreTests: XCTestCase {
        ...
        sut.retrieve { firstResult in
            sut.retrieve { secondResult in
                ...
                case (.empty, .empty):
                    break
                default:
                    XCTFail("Expected retrieving twice from empty cache to deliver same empty result, got \(firstResult) instead and \(secondResult) instead")
                }
    ...
    func test_retrieveAfterInsertingToEmptyCache_deliversInsertValues() {
        let sut = makeSUT()

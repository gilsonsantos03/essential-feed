...
class RemoteFeedLoaderTests: XCTestCase {
    ...
    func test_load_doesNotDeliverResultAfterSUTInstanceHasBeeDeallocated() {
    ...
    // this 'file' and 'line' is just to shows the error when asserting in the test method that fail
    ...
    private class HTTPClientSpy: HTTPClient {
        ...
        func complete(with error: Error, at index: Int = 0) {
            messages[index].completion(.failfure(error))
        }
